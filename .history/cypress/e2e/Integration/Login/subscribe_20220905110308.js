...
describe('subscribePage', () => {
    it('signupPage', () => {
        ...
        //cy.get('.col-md-4.px-md-2').should('contain.text','Be my BFF (ok, for a year)')
        //cy.get('.card.referal-disc-card').eq(2).should('contain.text','Love ya,but let’s take it slow...')
